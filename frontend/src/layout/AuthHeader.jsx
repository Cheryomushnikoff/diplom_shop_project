            ...
            {hideAuth ? (
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu custom-dropdown-menu-auth-mobile">
                  <li><span className="dropdown-item auth-item"><Link to='/profile'>{user.name || user.email}</Link></span></li>
                  <li><button className="dropdown-item auth-item" onClick={handleLogout}>Выход</button></li>
                </ul>
              </li>
            ) : (
              <div id="authDesktop" className="d-flex">
                ...
                <li className="nav-item custom-nav-item">
                  <button className="nav-link custom-link btn btn-link p-0" onClick={handleLogout}>Выход</button>
                </li>
              </div>
            )}
          </>
